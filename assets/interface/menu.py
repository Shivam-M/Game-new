...
class Menu:
    def __init__(self, instance):
        ...
        self.L_Title = Label(self.Menu_Frame, text='PLACEHOLDER', font=('Verdana', 30, 'bold'), bg=self.Game_Instance.Colour_Background, fg='#BDC3C7').place(relx=.05, rely=.1)
        ...
        self.L_Update = Button(self.Menu_Frame, text='Update Game', font=('MS PGothic', 13, 'bold'), bg=self.Game_Instance.Colour_Background, fg='#BDC3C7', bd=0, command=lambda: self.Game_Instance.UI_Updater.draw()).place(relx=.05, rely=.640)
        ...
        self.T_Names = Text(self.Menu_Frame, font=('MS PGothic', 13, 'bold'), bg=self.Game_Instance.Colour_Background, fg='#BDC3C7', width=15, height=10, bd=0)
        self.T_Scores = Text(self.Menu_Frame, font=('MS PGothic', 13, 'bold'), bg=self.Game_Instance.Colour_Background, fg='#BDC3C7', width=5, height=10, bd=0)

        self.T_Names.place(relx=.45, rely=.415)
        self.T_Scores.place(relx=.875, rely=.415)

        self.T_Names.insert(INSERT, 'Player 1\n\nPlayer 2\n\nPlayer 3\n\nPlayer 4\n\nPlayer 5')
        self.T_Scores.insert(INSERT, '91913\n\n73491\n\n42381\n\n33814\n\n12834')
